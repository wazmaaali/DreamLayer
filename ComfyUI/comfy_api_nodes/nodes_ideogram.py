...
class IdeogramV3(ComfyNodeABC):
    ...
    def api_call(
        ...
        **kwargs,
        ...
        print(f"[DEBUG] Generation request: {gen_request}")
        ...
        operation = SynchronousOperation(
            ...
            request=gen_request,
            api_base="https://api.ideogram.ai",
            auth_token=auth_token,  # Use the token from comfy_api_key
            content_type="multipart/form-data",
            files={},
            auth_kwargs={},
        )

        print(f"[DEBUG] Created operation with auth token: {auth_token}")
